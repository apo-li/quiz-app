...
router.post('/', async (req, res) => {
    const { text, answers, quizId, points, givenTime, createdAt, updatedAt } = req.body;
    const question = new Question(text, answers, quizId, points, givenTime, createdAt, updatedAt);
    try {  
